...
function ShaftVBA() {
  ...
  ' Exit the sketcher
  Dim swSketchSeg As SldWorks.SketchSegment = Nothing
  Dim swSketchSegExit As Boolean = swSketcher.ExitSketch()
  
  ' Create a revolve feature to create the shaft
  Dim swFeatRevolved As SldWorks.RevolutionFeature
  swFeatRevolved = swModel.Extension.RevolveCut(swSketchSeg, False, 0.0, 360.0)
  ...
  return (
    <div className="mockup-code">
      <div className="flex items-center">
        <p className="flex-1 ml-5">Shaft VBA Code</p>
        {copy ? (
